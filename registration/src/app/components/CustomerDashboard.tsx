      ...
      <nav className="bg-white border-b border-gray-200 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-6 py-3.5">
          <div className="flex items-center justify-between">
            ...
            {/* Right Side - Orders, Bookings, Cart, User Menu */}
            <div className="flex items-center space-x-6">
              ...
              <button
                ...
                className="text-gray-900 hover:text-[#1E2F4F] transition-colors"
              >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-2xl">
            ...
            <div className="flex items-center space-x-4 mb-10">
              ...
              <button
                onClick={onNavigateToPartsMarketplace}
                className="px-8 py-3.5 bg-white text-[#1E2F4F] border-2 border-[#1E2F4F] rounded-lg font-semibold hover:bg-gray-50 transition-colors"
                style={{ fontFamily: 'Poppins, sans-serif' }}
              >
                Shop Parts
              </button>
