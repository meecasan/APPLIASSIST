...
export const authAPI = {
  ...
  registerStoreOwner: async (data: {
    ...
    return fetchAPI<{ message: string }>('/auth/register-store-owner', {
      method: 'POST',
      body: JSON.stringify(data),
    });
  },
...
export const storesAPI = {
  ...
  checkStoreProfile: async () => {
    return fetchAPI<{ hasProfile: boolean; store_id?: number }>('/stores/profile/check', {
      method: 'GET',
    });
  },
};
...
export const adminAPI = {
  ...
  // Get pending store owners
  getPendingStoreOwners: async () => {
    return fetchAPI<any[]>('/admin/pending/store-owners', {
      method: 'GET',
    });
  },
  ...
  // Get rejected store owners
  getRejectedStoreOwners: async () => {
    return fetchAPI<any[]>('/admin/rejected/store-owners', {
      method: 'GET',
    });
  },
  ...
  // Approve store owner
  approveStoreOwner: async (ownerId: string) => {
    return fetchAPI<{ message: string }>(`/admin/approve/store-owner/${ownerId}`, {
      method: 'PUT',
    });
  },
  ...
  // Reject store owner
  rejectStoreOwner: async (ownerId: string) => {
    return fetchAPI<{ message: string }>(`/admin/reject/store-owner/${ownerId}`, {
      method: 'PUT',
    });
  },
};
