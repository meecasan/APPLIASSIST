...
export function ShopOwnerDashboard({ user, onLogout }: ShopOwnerDashboardProps) {
  ...
  const [hasServices, setHasServices] = useState(false); // Set to false to avoid service tabs when they are not available
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-sm text-[#6B7280]" style={{ fontFamily: 'Manrope, sans-serif' }}>
                    Manage your shop details and settings from one place.
                  </p>
                </div>
              </div>
              <div className="space-y-4">
                <div>
                  <p className="text-sm text-[#6B7280]" style={{ fontFamily: 'Instrument Sans, sans-serif' }}>
                    Email address
                  </p>
                  <p className="text-base font-medium text-gray-900" style={{ fontFamily: 'Poppins, sans-serif' }}>
                    {user.email}
                  </p>
                </div>
                <div>
