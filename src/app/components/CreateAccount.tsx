...
import { UserPlus, Mail, Lock, Wrench, Store } from 'lucide-react';
      ...
      <div className="w-full max-w-[480px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <Store className={`w-8 h-8 mb-2 ${role === 'shop-owner' ? 'text-blue-600' : 'text-gray-400'}`} />
                  <span className={`font-medium ${role === 'shop-owner' ? 'text-blue-600' : 'text-gray-700'}`}>
                    Shop Owner
                  </span>
                </button>
              </div>
        ...
        <div className="mt-6 p-4 bg-gray-50 border border-gray-200 rounded-lg">
          <p className="text-sm text-gray-600">
            <strong className="text-gray-900">Note:</strong> Select your role carefully. Technicians have access to service tools and parts, while Shop Owners can manage their shop and assign technicians.
          </p>
        </div>
      </div>
    </div>
