                ...
                {isDropdownOpen && (
                  <div className="absolute z-10 w-full mt-2 bg-white border border-gray-200 rounded-lg shadow-lg">
                    <button
                      ...
                      className="block w-full text-left px-4 py-3 hover:bg-gray-50 transition-colors first:rounded-t-lg"
                    >
                      Technician
                    </button>
                    <button
                      ...
                      className="block w-full text-left px-4 py-3 hover:bg-gray-50 transition-colors last:rounded-b-lg border-t border-gray-100"
                    >
                      Shop Owner
                    </button>
                  </div>
