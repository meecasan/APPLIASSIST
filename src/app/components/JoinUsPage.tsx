...
import { Wrench, Store, CheckCircle, Facebook, Twitter, Instagram, Mail, Phone, MapPin } from 'lucide-react';

interface JoinUsPageProps {
  onNavigateToTechnicianApplication: () => void;
  onNavigateToShopOwnerApplication: () => void;
...
export function JoinUsPage({
  ...
  onNavigateToShopOwnerApplication,
  onNavigateToHome,
  onNavigateToLogin,
    ...
    <div className="min-h-screen bg-[#F9FAFB]">
      ...
      <div className="max-w-7xl mx-auto px-8 py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {/* Technician Card */}
          <div className="bg-white rounded-2xl shadow-lg p-12 border border-gray-200 hover:shadow-xl transition-shadow">
            {/* Icon */}
          ...
          <div className="bg-white rounded-2xl shadow-lg p-12 border border-gray-200 hover:shadow-xl transition-shadow">
            {/* Icon */}
            <div className="w-20 h-20 bg-blue-50 rounded-full flex items-center justify-center mb-6">
              <Store className="w-10 h-10 text-[#1E2F4F]" />
            </div>
            ...
            {/* Description */}
            <p className="text-base text-[#6B7280] mb-8" style={{ fontFamily: 'Manrope, sans-serif' }}>
              List your appliance parts and reach thousands of customers
            </p>
            ...
            {/* CTA Button */}
            <button
              onClick={onNavigateToShopOwnerApplication}
              className="w-full px-6 py-4 rounded-lg bg-[#1E2F4F] text-white hover:bg-[#2a4066] font-medium text-lg transition-all"
              style={{ fontFamily: 'Poppins, sans-serif' }}
            >
              Apply as Shop Owner
